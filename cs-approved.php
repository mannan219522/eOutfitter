...
<?php
	...
	"WHERE oi.store_id = cs.user_id and oi.tailor_id = ts.tailor_id and oi.fabric_id = f.fabric_id and oi.store_id = '$cs_id' and oi.cs_approve = 1";
		            ...
		            <ul class="nav navbar-nav">
		                ...
		                <li class="dropdown">
		                    ...
		                    <ul class="dropdown-menu hudai">
		                        ...
		                        <li><a href="cs-cs-measurementprofile-view-old.php">View Old</a></li>
		                    </ul>
		                </li>
