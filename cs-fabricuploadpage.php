		        ...
		        <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
		            <ul class="nav navbar-nav">
		                ...
		                <li class="dropdown">
		                    ...
		                    <ul class="dropdown-menu hudai">
		                        <li><a href="cs-measurementprofile.html">Add New</a></li>
    ...
    <div class="container">
        <div class="col-md-offset-3 col-md-6 col-md-offset-3 col-sm-offset-2 col-sm-8 col-sm-offset-2 col-xs-offset-0 col-xs-12 col-xs-offset-0">
            <div class="signin-main">
                <h1></h1>
                <form action="fabricupload.php" method="post" enctype = "multipart/form-data">
					<input type="text" name="fabric_name" id="fabric_name" placeholder="Fabric Name" required="">
                    <input type="file" name="fabric_photo" id="fabric_photo" placeholder="Fabric Photo" required="">
					<input type="text" name="fabric_type" id="fabric_type" placeholder="Fabric Type" required="">
