...
// sql to delete a record
	if(isset($_GET["delId"])){
		$sql = "DELETE FROM cloth_store WHERE store_id='".$_GET["delId"]."'";
...
<div class="banner">
	...
	<?php 
		if($no_of_result==0) {
			?>
				<h1>No Cloth Store Available</h1>
			<?php
		}
		else {
	...
	?>
        <div class="banner-main">
            <div class="col-md-4">
                <p class="hudai420">Cloth Store Name: <?php echo $row["store_name"] ?></p>
            </div>
            <div class="col-md-3">
                <button class="btn btn-default maintain-page-button">
                    <a href="ad-cs-profile-view.php?id=<?php echo $row["store_id"]?>"">View Profile</a>
                </button>
            </div>
            <div class="col-md-2">
                <button class="btn btn-default maintain-page-button">
                    <a href="maintain-cs.php?delId=<?php echo $row["store_id"]?>">Ban Account</a>
                </button>
            </div>
            <div class="col-md-2">
                <button class="btn btn-default maintain-page-button">
                    <a href="maintain-cs.php?delId=<?php echo $row["store_id"]?>">Delete Account</a>
                </button>
            </div>
        </div>
		<?php } } ?>
