...
<div class="banner">
	<div class="container">
		<div class="banner-main">
		    <div class="col-md-4">
		        <button class="btn btn-default ad-h-button">
                    <a href="maintain-ru.php">Maintain Registered User</a>
		        </button>
		    </div>
		    <div class="col-md-4">
		        <button class="btn btn-default ad-h-button">
                    <a href="maintain-cs.php">Maintain Cloth Store</a>
		        </button>
		    </div>
		    <div class="col-md-4">
		        <button class="btn btn-default ad-h-button">
                    <a href="maintain-ts.php">Maintain Tailor Store</a>
		        </button>
		    </div>
		</div>
	</div>
