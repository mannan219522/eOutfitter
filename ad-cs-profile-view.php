...
<?php
	...
	$query = "SELECT * FROM `cloth_store` as cs, user as u WHERE cs.store_id = '".$_GET["id"]."' and cs.user_id = u.user_id";
...
<div class="banner">
    <div class="container">
        <div class="banner-main cs-profile-details">
            <ul>
                <li> Store Id: <?php echo $row["store_id"] ?></li>
                <li> Cloth Store Name: <?php echo $row["store_name"] ?></li>
                <li> Location: <?php echo $row["store_location"] ?></li>
                <li> Description: <?php echo $row["store_description"] ?> </li>
