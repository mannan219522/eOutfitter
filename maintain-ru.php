...
// sql to delete a record
	if(isset($_GET["delId"])){
		$sql = "DELETE FROM registered_user WHERE ru_id='".$_GET["delId"]."'";
...
<div class="banner">
	...
	<?php 
		if($no_of_result==0) {
			?>
				<h1>No Registered User Available</h1>
			<?php
		}
		else {
	...
	?>
        <div class="banner-main">
            <div class="col-md-3">
                <p class="hudai420">User Name: <?php echo $row["first_name"] ?></p>
            </div>
            <div class="col-md-3">
                <button class="btn btn-default maintain-page-button">
                    <a href="ad-ru-profile-view.php?id=<?php echo $row["ru_id"]?>">View Profile</a>
                </button>
            </div>
            <div class="col-md-3">
                <button class="btn btn-default maintain-page-button">
                    <a href="maintain-ru.php?delId=<?php echo $row["ru_id"]?>">Delete Account</a>
                </button>
            </div>
            <div class="col-md-3">
                <button class="btn btn-default maintain-page-button">
                    <a href="maintain-ru.php?delId=<?php echo $row["ru_id"]?>">Ban Account</a>
                </button>
            </div>
        </div>
		<?php } } ?>
