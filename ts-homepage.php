...
<?php
	...
	//if(isset($_GET["delId"])){
		//$sql = "DELETE FROM order_info WHERE order_id='".$_GET["delId"]."'";
	...
	$query = "SELECT * FROM  tailor_store as ts, order_info as oi WHERE ts.user_id = $id and ts.tailor_id = oi.tailor_id and oi.cs_approve = 1 and ts_approve=0";
...
<div class="banner">
	...
	?>
        <div class="banner-main ts-h-li">
            ...
            <div class="col-md-2">
                <button class="btn btn-default ts-h-button">
                    <a href="ts-orderdetails-page.php?id=<?php echo $row["order_id"] ?>">View Details</a>
                </button>
            </div>
            <div class="col-md-2">
			<button class="btn btn-default ts-h-button">
			<a href="ts-approval.php?approve=<?php echo $row["order_id"] ?>">Take Order</a>
			</button>
            </div>
            <div class="col-md-2">
			<button class="btn btn-default ts-h-button">
                <a href="ts-approval.php?reject=<?php echo $row["order_id"] ?>">Reject</a>
				</button>
            </div>
        </div>
		<?php } } ?>
