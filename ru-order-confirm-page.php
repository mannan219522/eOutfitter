...
<?php
	...
	if(isset($_POST["tailor_name"])){
		...
		if(isset($_POST["measuremet_id"])){
			$mes_id = mysqli_real_escape_string($conn, $_POST["measuremet_id"]);
		}
		else{
		...
		$query = "INSERT INTO `order_info` (`order_id`, `name`, `address`, `phone_no`, `email`, `data_id`, `store_id`, `tailor_id`, `fabric_id`) 
			...
			if(mysqli_query($conn, $query)){
				...
				header('Location: ru-pending-for-approval.php?id='.$abc);
			}
	}
?>
<!--header strat here-->
		    ...
		    <div class="header-right">
		        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		            <ul class="nav navbar-nav">
		                <li><a href="ru-fabric-choose-page.php">Design & Order</a></li>
		                <li class="dropdown">
		                    <a class=" scroll" data-toggle="dropdown" href="#">Measurement Profile</a>
		                    <ul class="dropdown-menu hudai">
		                        <li><a href="ru-measurementprofile.php">Add New</a></li>
		                        <li><a href="ru-measurementprofile-view-old.php">View Old</a></li>
		                    </ul>
		                </li>
        ...
        <div class="col-md-offset-3 col-md-6 col-md-offset-3 col-sm-offset-2 col-sm-8 col-sm-offset-2 col-xs-offset-0 col-xs-12 col-xs-offset-0">
            <div class="signin-main">
				...
				<?php } ?>
					...
					<h3>Provide Measurement Id (For Registered User)</h3>
                    <input type="text" name="measuremet_id" id="measuremet_id" class="no-margin" placeholder="Provide Measurement Id">
                    <h3>Or</h3>
                    ...
                    <input type="text" name="arm_hole" id="arm_hole" placeholder="arm hole">	
