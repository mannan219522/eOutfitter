...
<?php
	...
	$query = "SELECT * FROM `registered_user` as ru, user as u WHERE ru.ru_id = '".$_GET["id"]."' and ru.user_id = u.user_id";
...
<div class="banner">
    <div class="container">
        <div class="banner-main ru-profile-details">
            <ul>
                <li> User Id: <?php echo $row["ru_id"] ?></li>
                <li> Name: <?php echo $row["first_name"] . " " .  $row["last_name"] ?></li>
